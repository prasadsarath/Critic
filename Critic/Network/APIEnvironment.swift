...
enum AppEndpoints {
    ...
    enum Gateway {
        ...
        static let createPost = baseURL.appendingPathComponent("CreatePost")
        static let deletePost = baseURL.appendingPathComponent("DeletePost")
        static let reportPost = baseURL.appendingPathComponent("reportapost")
        ...
        static let moderation = baseURL.appendingPathComponent("AiHateSpeech")
    }
